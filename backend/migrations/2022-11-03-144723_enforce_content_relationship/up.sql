...
ALTER TABLE project ADD FOREIN KEY (id, content_type) REFERENCES content (id, content_type);
...
ALTER TABLE blog ADD FOREIN KEY (id, content_type) REFERENCES content (id, content_type);
