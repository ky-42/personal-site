...
ALTER TABLE project ADD CONSTRAINT project_id_fk FOREIGN KEY (content_id, content_type) REFERENCES content (id, content_type);
...
ALTER TABLE blog ADD CONSTRAINT blog_id_fk FOREIGN KEY (content_id, content_type) REFERENCES content (id, content_type);
