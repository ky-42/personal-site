...
export const NotificationContext = createContext({
  ...
  startTimer: (_notificationId: number) => {
    return;
  },
  stopTimer: (_notificationId: number) => {
    return;
  },
  addNotification: (_notification: NotificationInfo) => {
    return;
  },
  deleteNotification: (_notificationId: number) => {
    return;
  },
});
...
export const NotificationProvider = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <NotificationContext.Provider
      value={{ notifications, startTimer, stopTimer, deleteNotification, addNotification }}
    >
      {children}
    </NotificationContext.Provider>
  );
